            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>ERP System </span></a>
                    </div>
                </div>
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                              ...
                              <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{route('add.supplier')}}">Add Suppeliers</a></li>
                                    <li><a href="{{route('all.supplier')}}">All Suppeliers</a></li>
                              ...
                              <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span> salaries (EMP) </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="{{route('add.advancesalary')}}">Add Advance Salary</a></li>
                                    <li><a href="{{route('all.advancesalary')}}">All Advance Salary</a></li>

                                     <li><a href="{{route('pay.salary')}}">Paye Salary</a></li>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-palette"></i> <span> Categorys </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
...
<script src="https://kit.fontawesome.com/69787577b8.js" crossorigin="anonymous"></script>
        ...
        <script src="{{asset('public/admin/assets/counterup/jquery.counterup.min.js')}}"></script>
