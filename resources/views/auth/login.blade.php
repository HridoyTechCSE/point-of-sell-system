...
<div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Sign In to <strong>inventory managment</strong> </h3>
                </div> 
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <div class="checkbox checkbox-primary">
                                <input id="checkbox-signup remember" name="remember" type="checkbox" {{ old('remember') ? 'checked' : '' }}>
